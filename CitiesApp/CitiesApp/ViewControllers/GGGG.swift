...
//  CitiesApp
//
//  Created by Surgeont on 02.12.2021.
//

import UIKit

class GGGG: UIViewController {
...
extension GGGG: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
